export const Header = ({
  ...
  return (
    <header className="border border-slate-200 bg-slate-100/90 backdrop-blur-sm px-4 items-center py-2 rounded-md sticky z-40 top-[110px] max-w-screen-sm mx-auto w-full h-max flex mb-10">
